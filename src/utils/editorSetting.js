...
export class clearEditor extends BtnMenu {
  constructor(editor) {
    const $elem = E.$(
      '<div class="w-e-menu my-defined-icon" data-title="清空"><i class="el-icon-delete"></i></div>'
    )
    super($elem, editor)
  }
  clickHandler() {
...
export class videoEditor extends BtnMenu {
  constructor(editor) {
    const $elem = E.$(
      `<div class="w-e-menu my-defined-icon" data-title="视频"><i class="el-icon-video-camera-solid"></i></div>`
    )
    super($elem, editor)
